...
import { ArrowLeft, ArrowRight, ArrowUp, AudioLines, ChevronRight, Diamond, Flag, Maximize2, Pause, Play, RotateCcw, Snowflake, Target, Trophy, Volume2, VolumeX } from 'lucide-react';
...
export default function Home() {
  ...
  return <main className={`game-shell state-${game.status} mode-${game.mode}`}>
