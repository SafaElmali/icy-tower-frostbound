...
export default function Home() {
  ...
  function begin(selectedMode = mode) {
    ...
    setMode(selectedMode); startRun(engine.current, selectedMode);
  ...
  useEffect(() => {
    ...
    import('@/lib/tower-world').then(async ({ TowerWorld }) => {
      ...
      try {
        ...
        unregisterTools = registerGameTools(e, { start: selected => { startRun(e, selected); setMode(selected); setHelp(false); setGame(e.snapshot()); canvas.current?.focus(); }, pause: () => { resetInput(); e.togglePause(); setGame(e.snapshot()); } });
