...
import { ArrowLeft, ArrowRight, ArrowUp, AudioLines, ChevronRight, Diamond, Flag, Maximize2, Pause, Play, RotateCcw, Share2, Snowflake, Shirt, Target, Trophy, Volume2, VolumeX } from 'lucide-react';
...
export default function Home() {
  ...
  function startRun(e: TowerEngine, selectedMode: GameMode) {
    resetInput(); startChallengeRun(e, challengeRef.current, selectedMode);
