...
import { TowerEngine, freshControls, type GameMode, type Snapshot, type RunReplay } from '@/lib/tower-engine';
...
export default function Home() {
  ...
  function begin(selectedMode = mode) {
    ...
    resetInput(); engine.current.start(selectedMode, Math.floor(Math.random() * 2 ** 30));
