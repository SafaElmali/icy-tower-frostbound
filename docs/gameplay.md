...
Controls, tower mechanics, modes, progression, and personal ghosts. For online competition, see [leaderboards and friend challenges](leaderboard-and-sharing.md) or [two-player races](multiplayer.md).

- [Play](#play)
- [Party mode](#party-mode)
- [Tower action](#tower-action)
- [Learning and replayability](#learning-and-replayability)
- [Quick challenges](#quick-challenges)
- [Unlockable outfits](#unlockable-outfits)
- [Race your ghost](#race-your-ghost)
...
- During the first minute, guidance also explains releasing jump after landing and suggests a run-up when climbing stalls. Only the current tip is shown while learning, with the skill goal returning afterward.
- Results offer reachable floor 1, 3, and 5 targets before moving on to saved skill goals. Early normal retries below floor 5 reuse the opening layout when no compatible best ghost is available. New outfit rewards can be opened directly from results; early attempts also offer guided Practice without the rising frost chase.
- Returning players can start **Today’s tower** from the title screen after earning a skill milestone or reaching floor 5 in Classic. Daily results remind players that the shared tower changes at 00:00 UTC.
