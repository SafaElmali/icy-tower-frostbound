...
- Removed the separate Frenzy ring, retaining the existing icy recovery shield and crystal trail. The generated faceted shield image remains a concept, not an implemented asset.
