...
export class TowerEngine {
  ...
  constructor(seed = 73091, recordReplay = true, rulesVersion: RunReplay['version'] = CURRENT_RULES_VERSION) { this.seed = seed; this.recordReplay = recordReplay; this.rulesVersion = rulesVersion; this.resetWorld(); }
  ...
  start(mode: GameMode = 'arcade', seed = this.seed, rulesVersion = this.rulesVersion) {
